...
| 5 | Skill directory names filesystem-safe (`[a-z0-9-]`) and globally unique | PASS (203 unique) |
| 6 | Library entries total 202 (131 roles + 51 capabilities + 20 integrations); router skill counted separately as infrastructure | PASS |
...
| 8 | All 182 role/capability `SKILL.md` bodies byte-identical to source (verbatim preservation) | PASS |
