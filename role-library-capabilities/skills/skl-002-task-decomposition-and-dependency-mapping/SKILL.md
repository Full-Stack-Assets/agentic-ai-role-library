---
name: skl-002-task-decomposition-and-dependency-mapping
description: "Use when a workflow requires task decomposition & dependency mapping, particularly for orchestrators, release managers, or project controls."
---
...
**Common role families:** Orchestrators, release managers, project controls.

## Overview

Breaks approved work into bounded tasks, dependencies, owners, gates, and deadlines. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs task decomposition & dependency mapping and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Breaks approved work into bounded tasks, dependencies, owners, gates, and deadlines. |
...
3. Perform only this transformation: Breaks approved work into bounded tasks, dependencies, owners, gates, and deadlines.
...
- **Minimum fixture:** Multi-step request with a deliberate dependency conflict.
