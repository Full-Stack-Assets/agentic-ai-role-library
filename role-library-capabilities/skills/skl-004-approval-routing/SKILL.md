---
name: skl-004-approval-routing
description: "Use when a workflow requires approval routing, particularly for collaboration, approval, or release."
---
...
**Common role families:** Collaboration, approval, release, procurement.

## Overview

Selects the correct named approver from an approved authority matrix; never fabricates authority. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs approval routing and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Selects the correct named approver from an approved authority matrix; never fabricates authority. |
...
3. Perform only this transformation: Selects the correct named approver from an approved authority matrix; never fabricates authority.
...
- Selects the correct named approver from an approved authority matrix; never fabricates authority.
...
- **Minimum fixture:** Expired and delegated approver records.
