---
name: skl-006-claim-extraction-and-source-citation
description: "Use when a workflow requires claim extraction & source citation, particularly for research, pr, or rfp."
---

# Claim Extraction & Source Citation

**Skill ID:** `SKL-006`  
**Primary category:** Retrieval  
**Common role families:** Research, PR, RFP, policy, science.

## Overview

Extracts material factual claims and attaches traceable sources, dates, context, and uncertainty. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs claim extraction & source citation and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Extracts material factual claims and attaches traceable sources, dates, context, and uncertainty. |
...
3. Perform only this transformation: Extracts material factual claims and attaches traceable sources, dates, context, and uncertainty.
...
- **Minimum fixture:** Mixed-quality source bundle containing unsupported claims.
