---
name: skl-007-source-quality-assessment
description: "Use when a workflow requires source quality assessment, particularly for research, legal support, or market intelligence."
---
...
**Common role families:** Research, legal support, market intelligence.

## Overview

Assesses authority, primary/secondary status, recency, relevance, conflict, and provenance of evidence. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs source quality assessment and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Assesses authority, primary/secondary status, recency, relevance, conflict, and provenance of evidence. |
...
3. Perform only this transformation: Assesses authority, primary/secondary status, recency, relevance, conflict, and provenance of evidence.
...
- **Minimum fixture:** Contradictory sources with stale/non-authoritative records.
