---
name: skl-008-knowledge-retrieval-and-grounded-synthesis
description: "Use when a workflow requires knowledge retrieval & grounded synthesis, particularly for support, research, or documentation."
---

# Knowledge Retrieval & Grounded Synthesis

**Skill ID:** `SKL-008`  
**Primary category:** Retrieval  
**Common role families:** Support, research, documentation, healthcare education.

## Overview

Retrieves approved information and synthesizes it without inventing unsupported facts; exposes source gaps. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs knowledge retrieval & grounded synthesis and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Retrieves approved information and synthesizes it without inventing unsupported facts; exposes source gaps. |
...
3. Perform only this transformation: Retrieves approved information and synthesizes it without inventing unsupported facts; exposes source gaps.
...
- **Minimum fixture:** Query with no authoritative answer and expected abstention/escalation.
