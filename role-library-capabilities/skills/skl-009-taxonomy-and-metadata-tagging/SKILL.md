---
name: skl-009-taxonomy-and-metadata-tagging
description: "Use when a workflow requires taxonomy & metadata tagging, particularly for archivists, data stewards, or asset managers."
---
...
**Common role families:** Archivists, data stewards, asset managers.

## Overview

Applies controlled vocabularies, entity IDs, relationships, classification labels, and data-quality flags. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs taxonomy & metadata tagging and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Applies controlled vocabularies, entity IDs, relationships, classification labels, and data-quality flags. |
...
3. Perform only this transformation: Applies controlled vocabularies, entity IDs, relationships, classification labels, and data-quality flags.
...
- **Minimum fixture:** Assets with duplicate names, uncertain types, and missing owners.
