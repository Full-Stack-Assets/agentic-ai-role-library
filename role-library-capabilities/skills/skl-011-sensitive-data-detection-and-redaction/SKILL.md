---
name: skl-011-sensitive-data-detection-and-redaction
description: "Use when a workflow requires sensitive data detection & redaction, particularly for support, hr, or privacy."
---
...
**Common role families:** Support, HR, privacy, research, audit.

## Overview

Identifies probable personal, confidential, or restricted data and produces minimized/redacted derivative views. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs sensitive data detection & redaction and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Identifies probable personal, confidential, or restricted data and produces minimized/redacted derivative views. |
...
3. Perform only this transformation: Identifies probable personal, confidential, or restricted data and produces minimized/redacted derivative views.
...
- **Minimum fixture:** Mixed PII/PHI/confidential sample with permitted-role context.
