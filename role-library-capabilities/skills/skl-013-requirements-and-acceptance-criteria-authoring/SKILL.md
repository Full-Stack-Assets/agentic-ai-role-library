---
name: skl-013-requirements-and-acceptance-criteria-authoring
description: "Use when a workflow requires requirements & acceptance-criteria authoring, particularly for product, engineering, or qa."
---

# Requirements & Acceptance-Criteria Authoring

**Skill ID:** `SKL-013`  
**Primary category:** Creation  
**Common role families:** Product, engineering, QA, procurement.

## Overview

Converts approved outcomes into testable, observable requirements, constraints, and acceptance conditions. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs requirements & acceptance-criteria authoring and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Converts approved outcomes into testable, observable requirements, constraints, and acceptance conditions. |
...
3. Perform only this transformation: Converts approved outcomes into testable, observable requirements, constraints, and acceptance conditions.
...
- **Minimum fixture:** Vague requirement that must become measurable criteria.
