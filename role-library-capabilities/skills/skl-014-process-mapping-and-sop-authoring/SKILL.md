---
name: skl-014-process-mapping-and-sop-authoring
description: "Use when a workflow requires process mapping & sop authoring, particularly for operations, quality, or learning."
---

# Process Mapping & SOP Authoring

**Skill ID:** `SKL-014`  
**Primary category:** Creation  
**Common role families:** Operations, quality, learning, project controls.

## Overview

Maps inputs, decisions, controls, roles, steps, exceptions, and measurable outcomes. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs process mapping & sop authoring and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Maps inputs, decisions, controls, roles, steps, exceptions, and measurable outcomes. |
...
3. Perform only this transformation: Maps inputs, decisions, controls, roles, steps, exceptions, and measurable outcomes.
...
- **Minimum fixture:** Process with undefined owner and recovery path.
