---
name: skl-015-option-and-trade-off-analysis
description: "Use when a workflow requires option & trade-off analysis, particularly for architecture, strategy, or sourcing."
---
...
**Common role families:** Architecture, strategy, sourcing, planning.

## Overview

Compares alternatives against explicit criteria, uncertainty, cost, risk, reversibility, and constraints. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs option & trade-off analysis and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Compares alternatives against explicit criteria, uncertainty, cost, risk, reversibility, and constraints. |
...
3. Perform only this transformation: Compares alternatives against explicit criteria, uncertainty, cost, risk, reversibility, and constraints.
...
- **Minimum fixture:** Two plausible options with noncomparable benefits and risks.
