---
name: skl-017-quantitative-analysis-and-visualization
description: "Use when a workflow requires quantitative analysis & visualization, particularly for analytics, finance support, or operations."
---
...
**Common role families:** Analytics, finance support, operations, sustainability.

## Overview

Produces reproducible summaries, visualizations, segmentation, anomalies, and interpretation with stated limits. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs quantitative analysis & visualization and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Produces reproducible summaries, visualizations, segmentation, anomalies, and interpretation with stated limits. |
...
3. Perform only this transformation: Produces reproducible summaries, visualizations, segmentation, anomalies, and interpretation with stated limits.
...
- **Minimum fixture:** Dataset with nulls/outliers and metric-definition ambiguity.
