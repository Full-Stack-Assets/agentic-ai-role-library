---
name: skl-018-forecasting-and-scenario-modeling
description: "Use when a workflow requires forecasting & scenario modeling, particularly for planning, finance, or supply chain."
---
...
**Common role families:** Planning, finance, supply chain, revenue.

## Overview

Creates transparent base/upside/downside forecasts with explicit assumptions, sensitivity, and backtesting where applicable. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs forecasting & scenario modeling and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Creates transparent base/upside/downside forecasts with explicit assumptions, sensitivity, and backtesting where applicable. |
...
3. Perform only this transformation: Creates transparent base/upside/downside forecasts with explicit assumptions, sensitivity, and backtesting where applicable.
...
- **Minimum fixture:** Sparse/noisy time series with a structural-break condition.
