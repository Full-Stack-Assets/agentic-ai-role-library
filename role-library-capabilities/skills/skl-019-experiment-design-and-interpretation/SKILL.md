---
name: skl-019-experiment-design-and-interpretation
description: "Use when a workflow requires experiment design & interpretation, particularly for product, marketing, or learning."
---
...
**Common role families:** Product, marketing, learning, operations.

## Overview

Defines hypothesis, sample, assignments, metrics, guardrails, stopping rules, and cautious readouts. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs experiment design & interpretation and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Defines hypothesis, sample, assignments, metrics, guardrails, stopping rules, and cautious readouts. |
...
3. Perform only this transformation: Defines hypothesis, sample, assignments, metrics, guardrails, stopping rules, and cautious readouts.
...
- **Minimum fixture:** Experiment with contaminated assignment or inadequate sample.
