---
name: skl-020-natural-language-drafting-and-adaptation
description: "Use when a workflow requires natural-language drafting & adaptation, particularly for copy, pr, or support."
---

# Natural-Language Drafting & Adaptation

**Skill ID:** `SKL-020`  
**Primary category:** Creation  
**Common role families:** Copy, PR, support, product, learning.

## Overview

Drafts audience-appropriate content, documents, messages, and summaries from approved sources and tone constraints. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs natural-language drafting & adaptation and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Drafts audience-appropriate content, documents, messages, and summaries from approved sources and tone constraints. |
...
3. Perform only this transformation: Drafts audience-appropriate content, documents, messages, and summaries from approved sources and tone constraints.
...
- **Minimum fixture:** Source packet containing one prohibited/unverified claim.
