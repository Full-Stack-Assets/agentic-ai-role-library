---
name: skl-021-tone-brand-and-canon-conformance
description: "Use when a workflow requires tone, brand & canon conformance, particularly for creative, communications, or community."
---

# Tone, Brand & Canon Conformance

**Skill ID:** `SKL-021`  
**Primary category:** Evaluation  
**Common role families:** Creative, communications, community, design.

## Overview

Compares a draft to approved voice, personality, visual/sonic standards, and anti-examples; identifies drift. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs tone, brand & canon conformance and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Compares a draft to approved voice, personality, visual/sonic standards, and anti-examples; identifies drift. |
...
3. Perform only this transformation: Compares a draft to approved voice, personality, visual/sonic standards, and anti-examples; identifies drift.
...
- **Minimum fixture:** Draft containing subtle tone drift and false intimacy.
