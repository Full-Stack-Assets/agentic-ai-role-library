---
name: skl-023-accessibility-and-plain-language-review
description: "Use when a workflow requires accessibility & plain-language review, particularly for ux, education, or marketing."
---

# Accessibility & Plain-Language Review

**Skill ID:** `SKL-023`  
**Primary category:** Evaluation  
**Common role families:** UX, education, marketing, public service.

## Overview

Checks readability, captions, contrast/design guidance, keyboard/flow considerations, alt-text, and inclusive language. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs accessibility & plain-language review and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Checks readability, captions, contrast/design guidance, keyboard/flow considerations, alt-text, and inclusive language. |
...
3. Perform only this transformation: Checks readability, captions, contrast/design guidance, keyboard/flow considerations, alt-text, and inclusive language.
...
- **Minimum fixture:** Dense document and inaccessible media example.
