---
name: skl-025-audio-continuity-and-technical-qa
description: "Use when a workflow requires audio continuity & technical qa, particularly for voice governor, audio qa, or mastering."
---

# Audio Continuity & Technical QA

**Skill ID:** `SKL-025`  
**Primary category:** Evaluation  
**Common role families:** Voice governor, audio QA, mastering.

## Overview

Tests speech/music continuity, pronunciation, artifacts, loudness, metadata, and technical readiness. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs audio continuity & technical qa and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Tests speech/music continuity, pronunciation, artifacts, loudness, metadata, and technical readiness. |
...
3. Perform only this transformation: Tests speech/music continuity, pronunciation, artifacts, loudness, metadata, and technical readiness.
...
- **Minimum fixture:** Multiple audio candidates with voice/clip/label issues.
