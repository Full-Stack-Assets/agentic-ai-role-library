---
name: skl-026-code-generation-and-secure-implementation
description: "Use when a workflow requires code generation & secure implementation, particularly for software implementation or prototypes."
---

# Code Generation & Secure Implementation

**Skill ID:** `SKL-026`  
**Primary category:** Creation  
**Common role families:** Software implementation, prototypes.

## Overview

Creates maintainable code and tests within a bounded approved specification, including safe dependency and secret handling. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs code generation & secure implementation and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Creates maintainable code and tests within a bounded approved specification, including safe dependency and secret handling. |
...
3. Perform only this transformation: Creates maintainable code and tests within a bounded approved specification, including safe dependency and secret handling.
...
- **Minimum fixture:** Feature specification with malicious/user-supplied input tests.
