---
name: skl-028-test-design-and-defect-reproduction
description: "Use when a workflow requires test design & defect reproduction, particularly for qa, testing, or release readiness."
---

# Test Design & Defect Reproduction

**Skill ID:** `SKL-028`  
**Primary category:** Evaluation  
**Common role families:** QA, testing, release readiness.

## Overview

Creates positive, negative, boundary, regression, integration, and recovery tests; records reproducible evidence. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs test design & defect reproduction and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Creates positive, negative, boundary, regression, integration, and recovery tests; records reproducible evidence. |
...
3. Perform only this transformation: Creates positive, negative, boundary, regression, integration, and recovery tests; records reproducible evidence.
...
- **Minimum fixture:** Defect report missing environment/version information.
