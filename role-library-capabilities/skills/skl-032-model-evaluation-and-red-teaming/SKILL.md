---
name: skl-032-model-evaluation-and-red-teaming
description: "Use when a workflow requires model evaluation & red-teaming, particularly for ai evaluator, mlops, or product."
---
...
**Common role families:** AI evaluator, MLOps, product.

## Overview

Tests AI systems for task quality, grounding, leakage, unsafe behavior, bias risk, regressions, and refusal behavior. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs model evaluation & red-teaming and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Tests AI systems for task quality, grounding, leakage, unsafe behavior, bias risk, regressions, and refusal behavior. |
...
3. Perform only this transformation: Tests AI systems for task quality, grounding, leakage, unsafe behavior, bias risk, regressions, and refusal behavior.
...
- **Minimum fixture:** Representative benchmark including prompt injection and unsafe requests.
