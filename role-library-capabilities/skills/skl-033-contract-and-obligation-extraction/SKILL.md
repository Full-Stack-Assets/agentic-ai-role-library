---
name: skl-033-contract-and-obligation-extraction
description: "Use when a workflow requires contract & obligation extraction, particularly for contract intelligence, rights, or procurement."
---
...
**Common role families:** Contract intelligence, rights, procurement.

## Overview

Structures clauses, dates, parties, obligations, limitations, and comparison flags without interpreting law. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs contract & obligation extraction and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Structures clauses, dates, parties, obligations, limitations, and comparison flags without interpreting law. |
...
3. Perform only this transformation: Structures clauses, dates, parties, obligations, limitations, and comparison flags without interpreting law.
...
- **Minimum fixture:** Contract with conflicting amendments and undefined terms.
