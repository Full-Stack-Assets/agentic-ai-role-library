---
name: skl-034-reconciliation-and-variance-analysis
description: "Use when a workflow requires reconciliation & variance analysis, particularly for finance, revenue, or royalty."
---
...
**Common role families:** Finance, revenue, royalty, operations.

## Overview

Matches approved records, detects discrepancies, prioritizes exceptions, and prepares support evidence. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs reconciliation & variance analysis and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Matches approved records, detects discrepancies, prioritizes exceptions, and prepares support evidence. |
...
3. Perform only this transformation: Matches approved records, detects discrepancies, prioritizes exceptions, and prepares support evidence.
...
- **Minimum fixture:** Reconciling sources with timing differences and an unmatched record.
