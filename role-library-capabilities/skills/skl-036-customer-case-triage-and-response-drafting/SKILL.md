---
name: skl-036-customer-case-triage-and-response-drafting
description: "Use when a workflow requires customer/case triage & response drafting, particularly for support, hr, or casework."
---

# Customer/Case Triage & Response Drafting

**Skill ID:** `SKL-036`  
**Primary category:** Evaluation  
**Common role families:** Support, HR, casework, community.

## Overview

Classifies requests, retrieves approved guidance, drafts noncommittal responses, and detects urgent/sensitive escalation. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs customer/case triage & response drafting and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Classifies requests, retrieves approved guidance, drafts noncommittal responses, and detects urgent/sensitive escalation. |
...
3. Perform only this transformation: Classifies requests, retrieves approved guidance, drafts noncommittal responses, and detects urgent/sensitive escalation.
...
- **Minimum fixture:** User asks for a restricted action or legal/medical/financial advice.
