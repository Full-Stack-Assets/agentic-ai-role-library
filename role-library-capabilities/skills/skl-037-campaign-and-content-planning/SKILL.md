---
name: skl-037-campaign-and-content-planning
description: "Use when a workflow requires campaign & content planning, particularly for marketing, creative, or advocacy."
---
...
**Common role families:** Marketing, creative, advocacy, education.

## Overview

Maps approved campaign objectives to audiences, content pillars, assets, sequencing, test hypotheses, and measurement. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs campaign & content planning and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Maps approved campaign objectives to audiences, content pillars, assets, sequencing, test hypotheses, and measurement. |
...
3. Perform only this transformation: Maps approved campaign objectives to audiences, content pillars, assets, sequencing, test hypotheses, and measurement.
...
- **Minimum fixture:** Campaign brief with insufficient assets and conflicting audience goals.
