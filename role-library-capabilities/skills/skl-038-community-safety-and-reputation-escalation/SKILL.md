---
name: skl-038-community-safety-and-reputation-escalation
description: "Use when a workflow requires community safety & reputation escalation, particularly for community, support, or social."
---

# Community Safety & Reputation Escalation

**Skill ID:** `SKL-038`  
**Primary category:** Safety  
**Common role families:** Community, support, social, HR.

## Overview

Detects abuse, threats, self-harm indicators, harassment, vulnerable audiences, and reputation-sensitive conversations. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs community safety & reputation escalation and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Detects abuse, threats, self-harm indicators, harassment, vulnerable audiences, and reputation-sensitive conversations. |
...
3. Perform only this transformation: Detects abuse, threats, self-harm indicators, harassment, vulnerable audiences, and reputation-sensitive conversations.
...
- **Minimum fixture:** Conversation requiring immediate human response and non-engagement.
