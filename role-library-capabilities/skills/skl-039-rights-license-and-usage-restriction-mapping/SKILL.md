---
name: skl-039-rights-license-and-usage-restriction-mapping
description: "Use when a workflow requires rights, license & usage-restriction mapping, particularly for rights, licensing, or release."
---

# Rights, License & Usage-Restriction Mapping

**Skill ID:** `SKL-039`  
**Primary category:** Retrieval  
**Common role families:** Rights, licensing, release, procurement.

## Overview

Maps source/provider terms, permissions, expiry, territories, restrictions, and derivative eligibility. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs rights, license & usage-restriction mapping and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Maps source/provider terms, permissions, expiry, territories, restrictions, and derivative eligibility. |
...
3. Perform only this transformation: Maps source/provider terms, permissions, expiry, territories, restrictions, and derivative eligibility.
...
- **Minimum fixture:** Asset with unclear model terms and conflicting license evidence.
