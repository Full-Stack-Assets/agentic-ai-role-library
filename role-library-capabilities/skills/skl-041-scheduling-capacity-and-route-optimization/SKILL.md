---
name: skl-041-scheduling-capacity-and-route-optimization
description: "Use when a workflow requires scheduling, capacity & route optimization, particularly for operations planning, field service, or release calendar."
---

# Scheduling, Capacity & Route Optimization

**Skill ID:** `SKL-041`  
**Primary category:** Operations  
**Common role families:** Operations planning, field service, release calendar.

## Overview

Produces capacity-aware schedule options and collision/constraint warnings from authorized data. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs scheduling, capacity & route optimization and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Produces capacity-aware schedule options and collision/constraint warnings from authorized data. |
...
3. Perform only this transformation: Produces capacity-aware schedule options and collision/constraint warnings from authorized data.
...
- **Minimum fixture:** Schedule with unavailable resource, SLA conflict, and travel constraint.
