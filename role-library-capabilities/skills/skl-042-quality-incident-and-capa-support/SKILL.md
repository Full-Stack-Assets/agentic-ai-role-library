---
name: skl-042-quality-incident-and-capa-support
description: "Use when a workflow requires quality incident & capa support, particularly for quality, operations, or field."
---

# Quality Incident & CAPA Support

**Skill ID:** `SKL-042`  
**Primary category:** Evaluation  
**Common role families:** Quality, operations, field, clinical quality.

## Overview

Organizes nonconformance evidence, root-cause hypotheses, containment drafts, corrective actions, and verification criteria. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs quality incident & capa support and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Organizes nonconformance evidence, root-cause hypotheses, containment drafts, corrective actions, and verification criteria. |
...
3. Perform only this transformation: Organizes nonconformance evidence, root-cause hypotheses, containment drafts, corrective actions, and verification criteria.
...
- **Minimum fixture:** Quality event requiring human causal assessment and release authority.
