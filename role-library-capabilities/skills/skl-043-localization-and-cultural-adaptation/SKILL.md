---
name: skl-043-localization-and-cultural-adaptation
description: "Use when a workflow requires localization & cultural adaptation, particularly for distribution, marketing, or education."
---
...
**Common role families:** Distribution, marketing, education, product.

## Overview

Adapts content for language/region while preserving meaning, voice, rights, and local requirements; flags unverifiable claims. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs localization & cultural adaptation and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Adapts content for language/region while preserving meaning, voice, rights, and local requirements; flags unverifiable claims. |
...
3. Perform only this transformation: Adapts content for language/region while preserving meaning, voice, rights, and local requirements; flags unverifiable claims.
...
- **Minimum fixture:** Content with cultural idiom, regulatory claim, and layout constraints.
