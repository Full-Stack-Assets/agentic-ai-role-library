---
name: skl-044-meeting-decision-and-action-capture
description: "Use when a workflow requires meeting, decision & action capture, particularly for collaboration, project controls, or customer success."
---

# Meeting, Decision & Action Capture

**Skill ID:** `SKL-044`  
**Primary category:** Operations  
**Common role families:** Collaboration, project controls, customer success.

## Overview

Converts conversations into clearly attributed decisions, action items, owners, deadlines, open questions, and risks. This is a narrow, independently testable capability. It must be installed inside a role contract that defines authority, approved sources, integrations, and human approval boundaries.

## When to Use

Use this capability when a role needs meeting, decision & action capture and the required input, expected output, and acceptance test can be stated before execution. Do not use it to smuggle broader decision rights or hidden tool access into a role.
...
| Transformation | Converts conversations into clearly attributed decisions, action items, owners, deadlines, open questions, and risks. |
...
3. Perform only this transformation: Converts conversations into clearly attributed decisions, action items, owners, deadlines, open questions, and risks.
...
- **Minimum fixture:** Meeting containing ambiguous decision and conflicting owner assignments.
