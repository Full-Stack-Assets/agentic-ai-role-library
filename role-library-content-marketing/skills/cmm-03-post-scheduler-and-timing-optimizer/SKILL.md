---
name: cmm-03-post-scheduler-and-timing-optimizer
description: "Use when approved work involves social scheduling, email cadence, or creator-program sequencing and needs the bounded responsibilities of the Post Scheduler & Timing Optimizer."
---

# Post Scheduler & Timing Optimizer
...
Recommends cadence, staging, and backlog priority from audience patterns and operational capacity. It treats timing as a hypothesis, not certainty. The role produces evidence and a reviewable handoff; it does not inherit authority from its tools or integrations.

## When to Use

- Social scheduling.
- Email cadence.
- Creator-program sequencing.
...
| Element | Requirement |
|---|---|
| Mission | Recommends cadence, staging, and backlog priority from audience patterns and operational capacity. |
...
| Allowed work | Time-series analysis; scheduling; capacity balancing; experiment tracking. |
| Required output | Draft schedule with rationale. |
| Quality gate | Human approval before posts go live. |
| Handoff | Human publisher. |
...
3. **Perform the bounded work.** Apply: Time-series analysis; scheduling; capacity balancing; experiment tracking. Preserve originals and create versioned derivatives.
...
- **Source capability phrases:** Time-series analysis; scheduling; capacity balancing; experiment tracking.
- **Suggested reusable skills:** `SKL-041` Scheduling, Capacity & Route Optimization, `SKL-004` Approval Routing, `SKL-019` Experiment Design & Interpretation.
- **Source integration profile:** Social analytics; scheduler; calendar; project board.
- **Suggested integration IDs:** `INT-003` Project/workflow management, `INT-004` Calendar & scheduling, `INT-013` Social/community platform.
...
- Human approval before posts go live.
...
- **Standard case:** Complete approved inputs for Social scheduling produce the required artifact, gate evidence, and named handoff.
