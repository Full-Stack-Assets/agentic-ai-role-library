---
name: cmm-04-trend-and-opportunity-scanner
description: "Use when approved work involves trend scouting, creator brief ideation, or format research and needs the bounded responsibilities of the Trend & Opportunity Scanner."
---
...
Identifies relevant formats, cultural moments, and creative angles while documenting fit, volatility, and reputational risk. The role produces evidence and a reviewable handoff; it does not inherit authority from its tools or integrations.

## When to Use

- Trend scouting.
- Creator brief ideation.
- Format research.
...
| Element | Requirement |
|---|---|
| Mission | Identifies relevant formats, cultural moments, and creative angles while documenting fit, volatility, and reputational risk. |
...
| Allowed work | Trend monitoring; cultural-risk review; opportunity scoring; rapid brief creation. |
| Required output | Weekly opportunity brief and risk notes. |
| Quality gate | No tragedy, sensitive event, or canon-breaking exploitation. |
| Handoff | Content strategist/creative director. |
...
3. **Perform the bounded work.** Apply: Trend monitoring; cultural-risk review; opportunity scoring; rapid brief creation. Preserve originals and create versioned derivatives.
...
- **Source capability phrases:** Trend monitoring; cultural-risk review; opportunity scoring; rapid brief creation.
- **Suggested reusable skills:** `SKL-015` Option & Trade-off Analysis, `SKL-021` Tone, Brand & Canon Conformance, `SKL-043` Localization & Cultural Adaptation.
- **Source integration profile:** Social listening; web research; analytics dashboard; risk register.
- **Suggested integration IDs:** `INT-013` Social/community platform, `INT-009` Data warehouse / BI, `INT-019` External research/search services.
...
- **Standard case:** Complete approved inputs for Trend scouting produce the required artifact, gate evidence, and named handoff.
