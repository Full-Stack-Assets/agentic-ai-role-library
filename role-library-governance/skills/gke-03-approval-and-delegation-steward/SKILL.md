---
name: gke-03-approval-and-delegation-steward
description: "Use when approved work involves marketing approval routing, code-change approvals, or spending request preparation and needs the bounded responsibilities of the Approval & Delegation Steward."
---

# Approval & Delegation Steward
...
Maintains approval matrices, delegated-authority records, evidence of authorization, and expiry/revocation alerts. The role produces evidence and a reviewable handoff; it does not inherit authority from its tools or integrations.

## When to Use

- Marketing approval routing.
- Code-change approvals.
- Spending request preparation.
...
| Element | Requirement |
|---|---|
| Mission | Maintains approval matrices, delegated-authority records, evidence of authorization, and expiry/revocation alerts. |
...
| Allowed work | Authority validation; RACI mapping; workflow routing; audit evidence packaging. |
| Required output | Approval record and exception report. |
| Quality gate | No action marked approved without valid authority evidence. |
| Handoff | Authorized human approver. |
...
3. **Perform the bounded work.** Apply: Authority validation; RACI mapping; workflow routing; audit evidence packaging. Preserve originals and create versioned derivatives.
...
- **Source capability phrases:** Authority validation; RACI mapping; workflow routing; audit evidence packaging.
- **Suggested reusable skills:** `SKL-004` Approval Routing.
- **Source integration profile:** Identity provider; approval platform; HRIS; GRC system.
- **Suggested integration IDs:** `INT-016` Identity, IAM, and HRIS.
...
- No action marked approved without valid authority evidence.
...
- **Standard case:** Complete approved inputs for Marketing approval routing produce the required artifact, gate evidence, and named handoff.
