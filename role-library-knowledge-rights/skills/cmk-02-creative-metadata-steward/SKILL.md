---
name: cmk-02-creative-metadata-steward
description: "Use when approved work involves catalog metadata cleanup, content discovery, or playlist/press preparation and needs the bounded responsibilities of the Creative Metadata Steward."
---

# Creative Metadata Steward
...
Maintains song/asset identity, creative attributes, sonic and visual fields, release readiness, platform links, and performance metadata. The role produces evidence and a reviewable handoff; it does not inherit authority from its tools or integrations.

## When to Use

- Catalog metadata cleanup.
- Content discovery.
- Playlist/press preparation.
...
| Element | Requirement |
|---|---|
| Mission | Maintains song/asset identity, creative attributes, sonic and visual fields, release readiness, platform links, and performance metadata. |
...
| Allowed work | Schema validation; controlled vocabulary; entity resolution; metadata enrichment. |
| Required output | Validated metadata record. |
| Quality gate | Required fields complete and internally consistent. |
| Handoff | Release packager and archivist. |
...
3. **Perform the bounded work.** Apply: Schema validation; controlled vocabulary; entity resolution; metadata enrichment. Preserve originals and create versioned derivatives.
...
- **Source capability phrases:** Schema validation; controlled vocabulary; entity resolution; metadata enrichment.
- **Suggested reusable skills:** `SKL-009` Taxonomy & Metadata Tagging, `SKL-031` Data Quality Profiling & Drift Detection.
- **Source integration profile:** DAM; metadata database; distributor/CMS; analytics platform.
- **Suggested integration IDs:** `INT-006` DAM / media production suite, `INT-009` Data warehouse / BI, `INT-012` Marketing automation & CMS.
...
- **Standard case:** Complete approved inputs for Catalog metadata cleanup produce the required artifact, gate evidence, and named handoff.
