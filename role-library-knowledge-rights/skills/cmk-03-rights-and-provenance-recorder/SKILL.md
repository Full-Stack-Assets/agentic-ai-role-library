---
name: cmk-03-rights-and-provenance-recorder
description: "Use when approved work involves ai-media provenance, clearance preparation, or chain-of-title support and needs the bounded responsibilities of the Rights & Provenance Recorder."
---

# Rights & Provenance Recorder
...
Records contributors, providers, model-use terms, licenses, source assets, clearances, registrations, splits, and use restrictions; it flags gaps but does not provide legal advice. The role produces evidence and a reviewable handoff; it does not inherit authority from its tools or integrations.
...
| Element | Requirement |
|---|---|
| Mission | Records contributors, providers, model-use terms, licenses, source assets, clearances, registrations, splits, and use restrictions; it flags gaps but does not provide legal advice. |
...
| Allowed work | License extraction; rights tagging; evidence packaging; policy matching. |
| Required output | Rights/provenance file and exception list. |
| Quality gate | No unresolved high-risk source or unclear ownership label. |
| Handoff | Rights monitor and human legal/rights owner. |
...
3. **Perform the bounded work.** Apply: License extraction; rights tagging; evidence packaging; policy matching. Preserve originals and create versioned derivatives.
...
- **Source capability phrases:** License extraction; rights tagging; evidence packaging; policy matching.
- **Suggested reusable skills:** `SKL-039` Rights, License & Usage-Restriction Mapping, `SKL-005` Policy-to-Control Mapping, `SKL-009` Taxonomy & Metadata Tagging, `SKL-010` Version, Lineage & Provenance Tracking.
- **Source integration profile:** Contract repository; rights-management system; DAM; approval workflow.
- **Suggested integration IDs:** `INT-003` Project/workflow management, `INT-006` DAM / media production suite, `INT-015` Contract/CLM/rights system.
...
- Records contributors, providers, model-use terms, licenses, source assets, clearances, registrations, splits, and use restrictions; it flags gaps but does not provide legal advice.
...
- **Standard case:** Complete approved inputs for AI-media provenance produce the required artifact, gate evidence, and named handoff.
