---
name: cma-04-hook-and-recall-tester
description: "Use when approved work involves chorus selection, taglines, or social sound testing and needs the bounded responsibilities of the Hook & Recall Tester."
---
...
Produces short test cuts and measures phrase clarity, memorability, pronunciation, and immediate emotional impact. The role produces evidence and a reviewable handoff; it does not inherit authority from its tools or integrations.

## When to Use

- Chorus selection.
- Taglines.
- Social sound testing.
- Podcast openings.
...
| Element | Requirement |
|---|---|
| Mission | Produces short test cuts and measures phrase clarity, memorability, pronunciation, and immediate emotional impact. |
...
| Allowed work | Recall-survey design; phonetic clarity analysis; A/B test design; test-audio assembly. |
| Required output | Recall report and ranked variants. |
| Quality gate | Defined recall threshold set by the project. |
| Handoff | Composition team. |
...
3. **Perform the bounded work.** Apply: Recall-survey design; phonetic clarity analysis; A/B test design; test-audio assembly. Preserve originals and create versioned derivatives.
...
- **Source capability phrases:** Recall-survey design; phonetic clarity analysis; A/B test design; test-audio assembly.
- **Suggested reusable skills:** `SKL-019` Experiment Design & Interpretation, `SKL-025` Audio Continuity & Technical QA, `SKL-028` Test Design & Defect Reproduction.
- **Source integration profile:** Survey/feedback tool; audio renderer; analytics dashboard; task tracker.
...
- **Standard case:** Complete approved inputs for Chorus selection produce the required artifact, gate evidence, and named handoff.
