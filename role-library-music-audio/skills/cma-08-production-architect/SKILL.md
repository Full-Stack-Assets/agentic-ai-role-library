---
name: cma-08-production-architect
description: "Use when approved work involves arrangement selection, demo-to-master transition, or format-specific production and needs the bounded responsibilities of the Production Architect."
---
...
Integrates lyrics, melody, beat, stems, and voice map into intentionally different coherent arrangements. The role produces evidence and a reviewable handoff; it does not inherit authority from its tools or integrations.

## When to Use

- Arrangement selection.
- Demo-to-master transition.
...
| Element | Requirement |
|---|---|
| Mission | Integrates lyrics, melody, beat, stems, and voice map into intentionally different coherent arrangements. |
...
| Allowed work | Arrangement mapping; cue-sheet authoring; version comparison; production budgeting. |
| Required output | Three or more labeled arrangement candidates, cue sheet, section map. |
| Quality gate | Preserves vocal priority and defined song function. |
| Handoff | Demo vocal producer. |
...
3. **Perform the bounded work.** Apply: Arrangement mapping; cue-sheet authoring; version comparison; production budgeting. Preserve originals and create versioned derivatives.
...
- **Source capability phrases:** Arrangement mapping; cue-sheet authoring; version comparison; production budgeting.
- **Suggested reusable skills:** `SKL-025` Audio Continuity & Technical QA.
- **Source integration profile:** DAW; asset registry; project planning; review workflow.
- **Suggested integration IDs:** `INT-003` Project/workflow management, `INT-005` Asset management / object storage, `INT-006` DAM / media production suite.
...
- **Standard case:** Complete approved inputs for Arrangement selection produce the required artifact, gate evidence, and named handoff.
