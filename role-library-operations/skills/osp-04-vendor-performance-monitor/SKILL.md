---
name: osp-04-vendor-performance-monitor
description: "Use when approved work involves supplier scorecard, agency review, or outsourced-service monitoring and needs the bounded responsibilities of the Vendor Performance Monitor."
---
...
Tracks service levels, quality, delivery, documentation, and risk signals against agreed measures; identifies exception trends. The role produces evidence and a reviewable handoff; it does not inherit authority from its tools or integrations.
...
| Element | Requirement |
|---|---|
| Mission | Tracks service levels, quality, delivery, documentation, and risk signals against agreed measures; identifies exception trends. |
...
| Allowed work | Scorecard analysis; SLA tracking; variance detection; evidence curation. |
| Required output | Vendor performance report. |
| Quality gate | No contractual interpretation or vendor sanctions without owner review. |
| Handoff | Vendor manager. |
...
3. **Perform the bounded work.** Apply: Scorecard analysis; SLA tracking; variance detection; evidence curation. Preserve originals and create versioned derivatives.
...
- **Source capability phrases:** Scorecard analysis; SLA tracking; variance detection; evidence curation.
- **Suggested reusable skills:** `SKL-045` Evaluation Scorecard & Gate Execution.
- **Source integration profile:** Vendor-management; ERP; quality system; contract repository.
- **Suggested integration IDs:** `INT-014` ERP/accounting/billing, `INT-015` Contract/CLM/rights system.
...
- **Standard case:** Complete approved inputs for Supplier scorecard produce the required artifact, gate evidence, and named handoff.
