---
name: cmr-03-metadata-and-credits-steward
description: "Use when approved work involves dsp metadata, epk data, or media catalog maintenance and needs the bounded responsibilities of the Metadata & Credits Steward."
---

# Metadata & Credits Steward
...
Maintains titles, contributors, versions, IDs provided by authorized systems, lyrics, territories, credits, platform copy, and explicit-content fields. The role produces evidence and a reviewable handoff; it does not inherit authority from its tools or integrations.

## When to Use

- DSP metadata.
- EPK data.
- Media catalog maintenance.
...
| Element | Requirement |
|---|---|
| Mission | Maintains titles, contributors, versions, IDs provided by authorized systems, lyrics, territories, credits, platform copy, and explicit-content fields. |
...
| Allowed work | Metadata validation; credit normalization; territory mapping; duplicate detection. |
| Required output | Validated metadata sheet. |
| Quality gate | Facts confirmed against approved rights records. |
| Handoff | Human submission owner. |
...
3. **Perform the bounded work.** Apply: Metadata validation; credit normalization; territory mapping; duplicate detection. Preserve originals and create versioned derivatives.
...
- **Source capability phrases:** Metadata validation; credit normalization; territory mapping; duplicate detection.
- **Suggested reusable skills:** `SKL-039` Rights, License & Usage-Restriction Mapping, `SKL-001` Structured Intake Normalization, `SKL-009` Taxonomy & Metadata Tagging, `SKL-031` Data Quality Profiling & Drift Detection.
- **Source integration profile:** Metadata database; distributor platform; DAM; rights repository.
...
- **Standard case:** Complete approved inputs for DSP metadata produce the required artifact, gate evidence, and named handoff.
