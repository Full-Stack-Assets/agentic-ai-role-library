---
name: cmv-02-cover-art-and-poster-designer
description: "Use when approved work involves album cover, key art, or event poster and needs the bounded responsibilities of the Cover Art & Poster Designer."
---

# Cover Art & Poster Designer
...
Creates cover art, thumbnail families, banners, posters, and lockups that express the central contradiction with one beautiful and one intentionally “wrong” element. The role produces evidence and a reviewable handoff; it does not inherit authority from its tools or integrations.
...
| Element | Requirement |
|---|---|
| Mission | Creates cover art, thumbnail families, banners, posters, and lockups that express the central contradiction with one beautiful and one intentionally “wrong” element. |
...
| Allowed work | Layout design; art direction; typography; accessibility-safe text treatment. |
| Required output | Platform-specific artwork package. |
| Quality gate | Clear recognition at target size and canon alignment. |
| Handoff | Release packager. |
...
3. **Perform the bounded work.** Apply: Layout design; art direction; typography; accessibility-safe text treatment. Preserve originals and create versioned derivatives.
...
- **Source capability phrases:** Layout design; art direction; typography; accessibility-safe text treatment.
- **Suggested reusable skills:** `SKL-021` Tone, Brand & Canon Conformance, `SKL-023` Accessibility & Plain-Language Review.
- **Source integration profile:** Design tool; DAM; brand library; release metadata system.
...
- **Standard case:** Complete approved inputs for Album cover produce the required artifact, gate evidence, and named handoff.
