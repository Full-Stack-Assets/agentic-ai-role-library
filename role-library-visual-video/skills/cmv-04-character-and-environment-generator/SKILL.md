---
name: cmv-04-character-and-environment-generator
description: "Use when approved work involves character development, world building, or concept art and needs the bounded responsibilities of the Character & Environment Generator."
---

# Character & Environment Generator
...
Produces reference stills, wardrobe tests, locations, props, and variation libraries. No generated asset becomes canonical without continuity approval. The role produces evidence and a reviewable handoff; it does not inherit authority from its tools or integrations.
...
| Element | Requirement |
|---|---|
| Mission | Produces reference stills, wardrobe tests, locations, props, and variation libraries. |
...
| Allowed work | Image generation; prompt/version tracking; asset labeling; visual variation design. |
| Required output | Versioned still library with prompts and source IDs. |
| Quality gate | Clearly labeled candidate vs. approved canon. |
| Handoff | Motion test agent. |
...
3. **Perform the bounded work.** Apply: Image generation; prompt/version tracking; asset labeling; visual variation design. Preserve originals and create versioned derivatives.
...
- **Source capability phrases:** Image generation; prompt/version tracking; asset labeling; visual variation design.
- **Suggested reusable skills:** `SKL-021` Tone, Brand & Canon Conformance.
- **Source integration profile:** Image-generation workspace; DAM; visual ledger; rights registry.
...
- **Standard case:** Complete approved inputs for Character development produce the required artifact, gate evidence, and named handoff.
