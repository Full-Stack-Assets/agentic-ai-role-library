---
name: cmv-07-lyric-video-and-visualizer-builder
description: "Use when approved work involves full lyric visualizer, live background loop, or social lyric assets and needs the bounded responsibilities of the Lyric Video & Visualizer Builder."
---

# Lyric Video & Visualizer Builder
...
Builds timed visualizers, lyric videos, loops, and caption-safe fragments that are synchronized, readable, accessible, and stylistically consistent. The role produces evidence and a reviewable handoff; it does not inherit authority from its tools or integrations.

## When to Use

- Full lyric visualizer.
...
| Element | Requirement |
|---|---|
| Mission | Builds timed visualizers, lyric videos, loops, and caption-safe fragments that are synchronized, readable, accessible, and stylistically consistent. |
...
| Allowed work | Timecode alignment; typography animation; captioning; readability checking. |
| Required output | Full visualizer and accessibility-ready short fragments. |
| Quality gate | Lyrics, timecode, and safe margins verified. |
| Handoff | Content packager. |
...
3. **Perform the bounded work.** Apply: Timecode alignment; typography animation; captioning; readability checking. Preserve originals and create versioned derivatives.
...
- **Source capability phrases:** Timecode alignment; typography animation; captioning; readability checking.
- **Suggested reusable skills:** `SKL-023` Accessibility & Plain-Language Review.
- **Source integration profile:** Video editor; subtitle/caption tool; DAM; lyrics registry.
...
- **Standard case:** Complete approved inputs for Full lyric visualizer produce the required artifact, gate evidence, and named handoff.
